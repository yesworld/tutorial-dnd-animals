...
import { dataBackground, dataAnimals } from './sources.ts'
...
function initStage(images) {
  ...
  var outlines = {
    ...
    lion_black: {
      x: dataAnimals.lion.drop.x,
      y: dataAnimals.lion.drop.y,
    },
  }
  ...
  for (var key in animals) {
    ...
    ;(function () {
      ...
      var animal = new Konva.Image({
        ...
        y: anim.y,
        draggable: true,
        width: dataAnimals.lion.width,
        height: dataAnimals.lion.height,
      })
...
var sources = {
  ...
  lion: dataAnimals.lion.src,
  lion_glow: dataAnimals.lion.glow,
  lion_black: dataAnimals.lion.drop.src,
  // monkey: 'monkey.png',
